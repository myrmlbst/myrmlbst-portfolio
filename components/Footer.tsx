    ...
    <footer className="w-full pt-20 pb-[28vh]" id="contact">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          Ready to take {' '}
          <span className="text-purple">your own digital presence</span>
          {' '}to the next level?
        </h1>
      ...
      {/* additional links to LinkedIn and GitHub */}
      {/*
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light">@myrmlbst 2025</p>
      </div>
